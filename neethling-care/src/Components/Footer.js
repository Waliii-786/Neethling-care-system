      ...
      <div className="footer-container">
        <div className="ft-info">
          <div className="ft-info-p1">
            ...
            Get online help from the web for lumpy skin disease. 
            Get classifcation of Neehling Virus or LSD, precautionarhy measures, medicine recommendation, 
            and veterinary doctors location.
            </p>
          </div>
